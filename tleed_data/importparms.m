function tleedparms = importparms(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   TLEEDPARMS = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   TLEEDPARMS = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   tleedparms = importfile('tleedparms.dat', 26, 28);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/01/04 15:25:43
