...
C      PARAMETER (JPLOD=JLMMAX-JPLEV,JPNL=IPNL1*IPNL2)
...
C      COMPLEX TSTORE(2,JLMNI,NROMR,INST2)
      ...
      COMPLEX VL(JPNL,2),FLMS(JPNL,JPKLM),QCUT(IPCUT)
...
C113   FORMAT (' CPU TIME = ',F9.2,' SECONDS ')
