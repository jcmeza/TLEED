...
C called by it used), otherwise program crashes. 
      SUBROUTINE GPSkleed_wg(problem_dir,DIR,RANK,PARM,MINB,MAXB,NTYPE,
     & FITVAL)
	...
	write(*,*) ' rfactor GPSkleed_wg baino lehen al dago?'
 ...
 100   enddo          
	...
	write(*,*) 'before GPSkleed'
	write(*,*) NTYPE

       call GPSkleed(problem_dir,DIR,RANK,PARM_f,MINB_f,MAXB_f,NTYPE,
     & FITVAL_f)
       FITVAL=FITVAL_f
...
C     Call the computational routine.
      call GPSkleed_wg(in1(1:strlen), in2, in3, in4,in5, in6, in7,out1)
