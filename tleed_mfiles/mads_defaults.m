...
Labels.debug            = {'Off';'Level 1';'Level 2'};
...
Types.search    = {'None','LHS','Mesh','GA','SPollI','CPollI','GPollI', ...
                   'NW','DACE','SPS-NW','SPS-DACE','Custom','CustomS'};
...
for k = 1:maxSearches
   ...
   Options.Search(k).recal   = strncmp(Options.Search(k).type(end-1:end), ...
                                       'NW',2) || ...
                               strncmp(Options.Search(k).type(end-3:end), ...
                                       'DACE',4);
