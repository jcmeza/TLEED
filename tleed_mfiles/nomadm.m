...
guiFunction = { ...
   ...
   'edit_gui','search_gui','dace_gui','nw_gui','results_gui','solution_gui',...
   'loadEdit','loadSearchOptions','loadDACEOptions','loadNWOptions', ...
...
uicontrol(guiSearch.fig, 'Style', 'text', ...
    'String', 'Search #', ...
    'Position', [.01 .80 .07 .06]);
uicontrol(guiSearch.fig, 'Style', 'text', ...
    'String', 'Search Strategy', ...
    'Position', [.09 .80 .29 .06]);
uicontrol(guiSearch.fig, 'Style', 'text', ...
    'String', 'Number of Iterations', ...
    'Position', [.39 .80 .14 .06]);
uicontrol(guiSearch.fig, 'Style', 'text', ...
    'String', 'Number of Points', ...
    'Position', [.54 .80 .15 .06]);
uicontrol(guiSearch.fig, 'Style', 'text', ...
...
case {'SPS-DACE'}
   [sName,sPath] = uigetfile(spec,['Choose File for Search #',int2str(k)]);
   if (sName)
      guiDACE = dace_gui(k,gui_var,gui);
      set(guiDACE.fig,'UserData',{sPath,sName});
   else
      set(gcbo,'Value',previousType);
   end
...
case {'SPS-NW'}
   [sName,sPath] = uigetfile(spec,['Choose File for Search #',int2str(k)]);
   if (sName)
      guiNW = nw_gui(k,gui_var,gui);
      set(guiNW.fig,'UserData',{sPath,sName});
   else
      set(gcbo,'Value',previousType);
   end
...
%*******************************************************************************
function guiDACE = dace_gui(k,gui_var,gui)
...
guiDACE.done                 = uicontrol(guiDACE.fig, ...
      ...
      'Callback',            {gui.func.loadDACEOptions, 1, k});
guiDACE.cancel             = uicontrol(guiDACE.fig, ...
      'Style',               'pushbutton', ...
      'String',              'Cancel', ...
      'FontWeight',          'bold', ...
      'Position',            [.54, .02, .18, .12], ...
      'Callback',            {gui.func.loadDACEOptions, 0, k});
...
if loadDACE
   ...
   UserData = get(guiDACE.fig,'UserData');
   if isempty(UserData)
...
%*******************************************************************************
function guiNW = nw_gui(k,gui_var,gui)
...
guiNW.done                 = uicontrol(guiNW.fig, ...
      ...
      'FontWeight',          'bold', ...
      'Position',            [.27, .02, .18, .12], ...
      'Callback',            {gui.func.loadNWOptions, 1, k});
guiNW.cancel             = uicontrol(guiNW.fig, ...
      'Style',               'pushbutton', ...
      'String',              'Cancel', ...
      'FontWeight',          'bold', ...
      'Position',            [.54, .02, .18, .12], ...
      'Callback',            {gui.func.loadNWOptions, 0, k});
...
if loadNW
   ...
   UserData = get(guiNW.fig,'UserData');
   if isempty(UserData)
      set(guiSearch.Screen(k).file, 'UserData', '');
      set(guiSearch.Screen(k).file, 'String',   '');      
   else
